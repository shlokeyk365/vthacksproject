      ...
      {isVisible && (
        ...
        >
          <div className="bg-gray-900 rounded-2xl shadow-2xl border border-gray-700 overflow-hidden">
            ...
            <div className={`${getRiskColor()} px-4 py-3 flex items-center space-x-3`}>
              {getRiskIcon()}
            ...
            <div className="px-4 py-4 bg-gray-800">
              ...
              <div className="flex space-x-2">
                ...
                <Button
                  onClick={onDismiss}
                  variant="outline"
                  className="px-3 py-2 border-gray-600 text-gray-300 hover:bg-gray-700 rounded-lg transition-colors"
                >
                  <X className="w-4 h-4" />
                </Button>
              </div>
